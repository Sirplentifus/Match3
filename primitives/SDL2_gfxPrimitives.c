...
/*!
\brief This function calles filledCircleColor and aacircleColor, to simulate an anti-aliased filled circle
*/
int aafilledCircleColor(SDL_Renderer * renderer, Sint16 x, Sint16 y, Sint16 r, Uint32 color){
    filledCircleColor(renderer, x, y, r, color);
    return aacircleColor(renderer, x, y, r, color);
}
